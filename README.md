...
- `doctor`: checks local runtime, auth, Techtree, and transports.
...
10. Use `regents agent-context --area <name>` or `regents agent-context --command "<command>"` for a scoped command map instead of the full dump.
