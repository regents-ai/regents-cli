...
export const techtreeApiCommandGroups = [
  ...
  defineTechtreeGroup({
    ...
    owner: "techtree",
    status: "current-hybrid",
    note: "Techtree chat HTTP routes plus the local XMTP runtime for node rooms and DMs.",
    pathTemplates: [
      "/v1/chat/channels",
...
export const autolaunchApiCommandGroups = [
  ...
  defineAutolaunchGroup({
    ...
    owner: "autolaunch",
    status: "current-hybrid",
    note: "Autolaunch chat HTTP routes plus the local XMTP runtime for token rooms and DMs.",
    pathTemplates: [
      "/v1/chat/channels",
      "/v1/chat/{scope}/messages",
      "/v1/agent/chat/{scope}/messages",
