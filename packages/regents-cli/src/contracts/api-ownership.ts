...
export const autolaunchApiCommandGroups = [
  defineAutolaunchGroup({
    ...
    owner: "autolaunch",
    status: "current",
    pathTemplates: ["/api/autolaunch/v1/agent/agents", "/api/autolaunch/v1/agent/agents/{id}", "/api/autolaunch/v1/agent/agents/{id}/readiness"],
  }),
  defineAutolaunchGroup({
  ...
  defineAutolaunchGroup({
    ...
    pathTemplates: [
      ...
      "/api/autolaunch/v1/agent/bids/{id}/return-quote-token" as keyof AutolaunchPaths,
  ...
  defineAutolaunchGroup({
    ...
    owner: "autolaunch",
    status: "current",
    pathTemplates: ["/api/autolaunch/v1/agent/ens/link/plan", "/api/autolaunch/v1/agent/ens/link/prepare-ensip25", "/api/autolaunch/v1/agent/ens/link/prepare-erc8004", "/api/autolaunch/v1/agent/ens/link/prepare-bidirectional"],
  }),
  defineAutolaunchGroup({
    commands: [
