...
import type { DoctorReport, RegentConfig } from "../internal-types/index.js";

import { defaultConfigPath } from "../internal-runtime/index.js";
import { getBooleanFlag, getFlag, type ParsedCliArgs, parseCliArgs } from "../parse.js";
import { CLI_PALETTE, renderPanel, tone } from "../printer.js";
import {
...
import { startWizardDeps, type StartWizardResult } from "./techtree-start.js";
