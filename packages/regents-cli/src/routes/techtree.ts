...
import {
  ...
  runTechtreeHeartbeatComplete,
  runTechtreeHeartbeatList,
  runTechtreeHeartbeatSchedule,
  runTechtreeHeartbeatStart,
...
export const techtreeHandlers: CliHandlerRegistry = {
  ...
  "techtree heartbeats schedule": { run: ({ parsedArgs, configPath }) => runTechtreeHeartbeatSchedule(parsedArgs, configPath) },
  "techtree heartbeats list": { run: ({ parsedArgs, configPath }) => runTechtreeHeartbeatList(parsedArgs, configPath) },
  "techtree heartbeats start": { run: ({ parsedArgs, configPath }) => runTechtreeHeartbeatStart(parsedArgs, configPath) },
  "techtree heartbeats complete <wakeup_id>": { run: ({ parsedArgs, configPath }) => runTechtreeHeartbeatComplete(parsedArgs, configPath) },
